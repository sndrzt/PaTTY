...
#define WINHELP_CTX_window_termx1 "config-termx1"
#define WINHELP_CTX_window_termy1 "config-termy1"
#define WINHELP_CTX_window_termx2 "config-termx2"
#define WINHELP_CTX_window_termy2 "config-termy2"
#define WINHELP_CTX_window_bmcx1 "config-bmcx1"
#define WINHELP_CTX_window_bmcy1 "config-bmcy1"
#define WINHELP_CTX_window_bmcx2 "config-bmcx2"
#define WINHELP_CTX_window_bmcy2 "config-bmcy2"
...
#define WINHELP_CTX_window_triggertext1 "config-triggertext1"
#define WINHELP_CTX_window_triggeraction1 "config-triggeraction1"
#define WINHELP_CTX_window_triggertext2 "config-triggertext2"
#define WINHELP_CTX_window_triggeraction2 "config-triggeraction2"
